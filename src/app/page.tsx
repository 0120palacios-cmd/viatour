...
export default function Home() {
  return <main><Hero /><HowItWorks /><FeaturedDestinations /><DiscoverTeaser /><FeaturedPackages /><Services /><WhyViatour /><SocialReels /><ReviewsTeaser /><TravelGuides /><FrequentlyAskedQuestions /><TravelRequirements /><FinalCta /><Newsletter /></main>;
}
