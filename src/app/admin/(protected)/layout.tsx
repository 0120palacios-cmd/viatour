...
import { LayoutDashboard, Star, Luggage, MapPin, ListChecks, BookOpen, CircleHelp, Users, FileText } from "lucide-react";
...
export default async function Layout({ children }: {
    ...
    const sections = [["Resumen", "/admin", LayoutDashboard], ["Clientes", "/admin/clientes", Users], ["Cotizaciones", "/admin/cotizaciones", FileText], ["Opiniones", "/admin/opiniones", Star], ["Paquetes", "/admin/paquetes", Luggage], ["Destinos", "/admin/destinos", MapPin], ["Leads", "/admin/leads", ListChecks], ["Blog", "/admin/blog", BookOpen], ["FAQ", "/admin/faq", CircleHelp]] as const;
