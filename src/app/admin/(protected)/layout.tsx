...
import { LayoutDashboard, Star, Luggage, MapPin, ListChecks, BookOpen } from "lucide-react";
...
export default async function Layout({ children }: {
    ...
    const sections = [["Resumen", "/admin", LayoutDashboard], ["Opiniones", "/admin/opiniones", Star], ["Paquetes", "/admin/paquetes", Luggage], ["Destinos", "/admin/destinos", MapPin], ["Leads", "/admin/leads", ListChecks], ["Blog", "/admin/blog", BookOpen]] as const;
