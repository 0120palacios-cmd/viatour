...
export function ReviewForm({ destinations, invitation }: { destinations: string[]; invitation?: { token: string; nombre: string; email: string } }) {
